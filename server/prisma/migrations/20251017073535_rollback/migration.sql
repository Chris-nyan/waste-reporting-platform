...
-- DropForeignKey
ALTER TABLE "public"."RecyclingProcess" DROP CONSTRAINT "RecyclingProcess_wasteEntryId_fkey";

-- DropForeignKey
ALTER TABLE "public"."WasteEntry" DROP CONSTRAINT "WasteEntry_clientId_fkey";

-- DropForeignKey
ALTER TABLE "public"."WasteEntry" DROP CONSTRAINT "WasteEntry_createdById_fkey";

-- DropForeignKey
ALTER TABLE "public"."WasteEntry" DROP CONSTRAINT "WasteEntry_pickupLocationId_fkey";

-- DropForeignKey
ALTER TABLE "public"."WasteEntry" DROP CONSTRAINT "WasteEntry_vehicleTypeId_fkey";

-- DropForeignKey
ALTER TABLE "public"."WasteEntry" DROP CONSTRAINT "WasteEntry_wasteTypeId_fkey";
...
-- DropEnum
DROP TYPE "public"."WasteEntryStatus";
